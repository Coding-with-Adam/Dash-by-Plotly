...
def add_row(data):
    ...
    fig_hist = px.histogram(df_grpah, x='age',color="animal")
    fig_pie = px.histogram(df_grpah, x="neutered")
    return [
        html.Div(children=[dcc.Graph(figure=fig_hist)], className="six columns"),
        html.Div(children=[dcc.Graph(figure=fig_pie)], className="six columns")
    ]
