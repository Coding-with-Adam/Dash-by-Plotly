...
app.layout = html.Div([
    ...
    dcc.Dropdown(id='ticker-name', options=['TSLA','FB','AMZN'], value='TSLA', clearable=False, style={'width': '25%'}),
    html.Div(id='price-placeholder', children=[]),
    dcc.Graph(id='line-history', figure={}),
    html.Hr(),

    html.Div('Whould you like to set up email or phone alerts for price changes?'),
