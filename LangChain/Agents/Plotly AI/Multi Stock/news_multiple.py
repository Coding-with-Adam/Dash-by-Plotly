# code was slightly modified. Original code by Troy Scribner -- https://github.com/troyscribner
...
def query_news(symbol, alphavantage_apikey):
    ...
    if symbol:
        ...
        df["ticker"] = df["ticker_sentiment"].apply(get_ticker)
    ...
    news_df = df[['ticker', 'title', 'summary', 'url', 'relevance', 'sentiment']]
